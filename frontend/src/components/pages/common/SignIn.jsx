  ...
  async function verifiyUser() {
    ...
    switch (userRole) {
      case "admin":
        ...
        break;
      case "patient":
        signInUrl = patientSign;
        break;
      case "doctor":
        signInUrl = doctorSign;
        break;
    }
    await axios
      .post(signInUrl, {
  ...
  return (
    <>
      <div id="signin">
        ...
        <form
          class="max-w-screen  border  flex justify-center items-center rounded-md mx-auto"
          style={{ height: "100vh" }}
        >
              ...
              <>
                <div className="bg-[#4885ed] text-white">
                  <label class="flex justify-center  bg-[#4885ed]  font-bold text-white text-sm sm:text-base mb-2 ">
                    ...
                    <p className="uppercase bg-[#4885ed] "> &nbsp;{userRole}</p>
                  </label>
                  <br />
                  <label
                    for="email"
                ...
                <span class="text-[#FFFF00] uppercase text-center text-sm bg-[#4885ed] ">
                  {errorMessage}
                </span>
