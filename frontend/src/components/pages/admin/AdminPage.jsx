          ...
          <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
            ...
            <div className="panel w-1/2 mx-auto flex flex-1 items-center justify-center  sm:items-stretch sm:justify-between">
              <div className="flex space-x-6">
                {roles.map((item) => (
                  <button className="hover:border-b-4 border-indigo-500 hover:text-indigo-500 hover:cursor-pointer focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 ">
                    {item}
                  </button>
                ))}
              </div>
