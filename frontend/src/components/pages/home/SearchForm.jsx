        ...
        <form>
            <div className='flex px-20'>
                ...
                <div className="relative w-5/6 items-center">
                    ...
                    <button type="submit" className="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-white rounded-r-lg border   focus:ring-4 focus:outline-none focus:ring-blue-300 " onClick={()=>{toSearchPage()}}>
